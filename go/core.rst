...
**NOTE:** ``go_path`` is experimental. Its interface may change without
advance notice between major releases.
...
| provide GoArchive_ (`go_library`_, `go_binary`, `go_test`_, and similar                          |
| rules have this).                                                                                |
|                                                                                                  |
